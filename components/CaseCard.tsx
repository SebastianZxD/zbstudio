...
export const CaseCard = ({ id, title, description, imageUrl }: CaseCardProps) => {
  ...
  if (isUnderConstruction) {
    return (
      <CardContainer className="w-[400px] lg:max-w-[350px]">
  ...
  return (
    <BackgroundGradient className="border-black border-2 hover:border-white rounded-xl">
      <Link href={`/cases/${id}`}>
        <CardContainer className="w-[400px] lg:max-w-[350px]">
          <CardBody className="relative group/card hover:shadow-2xl hover:shadow-emerald-500/[0.1] bg-black w-auto sm:w-[30rem] h-auto rounded-[10px] p-6 border-none">
            <CardItem
              translateZ="50"
